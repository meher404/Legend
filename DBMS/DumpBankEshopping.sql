...
--
-- Current Database: `bankeshopping`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `bankeshopping` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
INSERT INTO `accountdetails` VALUES (6987654321,500000),(6987654322,500000),(6987654323,498400);
...
INSERT INTO `bankuser` VALUES (6987654321,'nikhitha','123456','kalwakurthy','nikhitha@gmail.com',9494268894,'female','1992-02-01',1,'123456'),(6987654322,'meher','msit123','hyderabad','meher.almighty@gmail.com',9874563210,'male','1992-01-01',1,'453956'),(6987654323,'Ravi','msit123','Himayathnagar','singam.999@gmail.com',9866441003,'male','1990-02-01',1,'484758');
...
--
-- Current Database: `eshopping`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `eshopping` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
INSERT INTO `bills` VALUES ('1992-01-01 00:00:00',1001,'sale001',375.00,'pending'),('2013-02-02 00:00:00',1001,'sale002',400.00,'delivered'),('2014-02-13 13:18:47',610060,'sale00175',100400.00,'pending'),('2014-02-13 14:51:17',610060,'sale0021',400.00,'pending'),('2014-02-13 14:57:25',610060,'sale0038',400.00,'pending'),('2014-02-13 15:55:21',51008,'sale0056',40000.00,'pending'),('2014-02-13 16:00:49',51008,'sale00282',400.00,'pending'),('2014-02-13 17:23:29',610060,'sale003',1600.00,'pending');
...
INSERT INTO `category` VALUES (100,'mobile'),(178,'computers'),(200,'camera'),(300,'books'),(400,'watches'),(1187,'cosmetics'),(1209,'handycam');
...
INSERT INTO `orderdetails` VALUES ('sale001','binn9','book001',2),('sale001','binn9','book002',3),('sale00175','nikh0','178232',2),('sale00175','nikh0','300213',1),('sale002','binn9','book001',3),('sale0021','nikh0','300213',1),('sale00282','mehe8','300213',1),('sale003','nikh0','300213',4),('sale0038','nikh0','300213',1),('sale0056','mehe8','100147',1);
...
INSERT INTO `registration` VALUES ('ravi3',193240,'not-activated'),('nikh1',506024,'not-activated'),('teja2',469250,'not-activated'),('mehe8',291176,'active'),('srir3',209121,'not-activated'),('hari8',772881,'active'),('adep6',743519,'active'),('nikh9',366705,'active'),('Rahu4',532500,'not-activated'),('nikh0',720214,'active');
...
-- Dump completed on 2014-02-14 10:11:08
